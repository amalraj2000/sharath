        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl tracking-tight">Sharath<span className="text-safety-amber"> Kumar V</span></span>
            </div>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><motion.a whileHover={{ x: 5 }} href="#experience" className="inline-block text-concrete-200 hover:text-safety-amber transition-colors text-sm">Experience</motion.a></li>
